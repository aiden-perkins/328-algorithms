...
int main(int argc, char* argv[]) {
    map<string, function<double(string)>> singleFileInput = {
        ...
        {"MinimumSpanningTreesfastest", &MinimumSpanningTrees::primMinHeap},
        {"MinimumSpanningTreesprim", &MinimumSpanningTrees::primMinHeap},
        {"MinimumSpanningTreesprim", &MinimumSpanningTrees::primArray},
